        ...
        <header style={{
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto", padding: "14px 32px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
              <button className="btn-ghost2" style={{ border: `1.5px solid ${scrolled ? "#e2e8f0" : "rgba(255,255,255,.35)"}`, color: scrolled ? "#334155" : "white" }} onClick={() => navigate("/login")}>Entrar</button>
