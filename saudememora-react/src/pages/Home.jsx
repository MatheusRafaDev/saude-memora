  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: 14.5, color: "#64748b", lineHeight: 1.65 }}>
          {desc}
        </div>
      </div>
      <div
  ...
  return (
    ...
    >
      ...
      <div style={{ paddingTop: 4 }}>
        ...
        <div style={{ fontSize: 14.5, color: "#64748b", lineHeight: 1.6 }}>
          {desc}
        </div>
      </div>
    </div>
...
function CtaSection({ onNavigate }) {
  ...
  return (
    ...
    >
      ...
      >
        Crie sua conta gratuitamente e organize todos os seus documentos médicos
        hoje mesmo.
      </p>
      <div
        style={{
...
export default function Home() {
  ...
  return (
    <>
      <style>{`
        @import url('https:
        //fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,700;0,9..144,900;1,9..144,700&family=Outfit:wght@300;400;500;600&display=swap');
      ...
      >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                  <path
                    d="M12 21s-9-6-9-11a5 5 0 0110 0 5 5 0 0110 0c0 5-9 11-11 11z"
                    fill="rgba(255,255,255,.9)"
                  />
                  <path
                    d="M9 13h2l1-3 2 6 1.5-3H18"
            ...
            <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
              <button
                className="btn-ghost"
                style={{
                  border: `1.5px solid ${scrolled ? "#e2e8f0" : "rgba(255,255,255,.35)"}`,
        ...
        <section
          style={{
            ...
            overflow: "hidden",
            background:
              "linear-gradient(150deg,#1e40af 0%,#2563eb 45%,#0ea5e9 100%)",
            display: "flex",
            flexDirection: "column",
            justifyContent: "center",
        ...
        >
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  left: b.left,
                  background: b.bg,
                  animation: `floatY ${b.dur}s ease-in-out infinite`,
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  O SaúdeMemora digitaliza, organiza e centraliza todos os seus
                  documentos de saúde — exames, receitas e fichas médicas — com
                  inteligência artificial e OCR avançado.
                </p>
                <div
                  className="hero-ctas"
                  style={{
                      ...
                      {[35, 55, 42, 78, 60, 88, 70].map((h, i) => (
                        <div
                          ...
                          style={{
                            ...
                            animation: `barsGrow .6s cubic-bezier(.22,1,.36,1) ${i * 60 + 400}ms both`,
                          }}
                        />
                      ))}
                    </div>
          ...
          >
            ...
            >
              <path
                d="M0 60V30C360 0 720 60 1080 30C1260 15 1380 30 1440 30V60Z"
                fill="#f8fafc"
              />
            </svg>
          </div>
        ...
        {/* FEATURES */}
        <section
          style={{ padding: "96px 32px", maxWidth: 1200, margin: "0 auto" }}
        >
          <SectionHeader
                      ...
                      {[40, 65, 50, 80, 55, 90, 70].map((h, i) => (
                        <div
                          ...
                          style={{
                            ...
                            transformOrigin: "bottom",
                            animation: `barsGrow .5s cubic-bezier(.22,1,.36,1) ${i * 60 + 200}ms both`,
                          }}
                        />
                      ))}
                    </div>
        ...
        <footer style={{ background: "#0f172a", padding: "48px 32px" }}>
          ...
          >
            ...
            <p style={{ color: "#475569", fontSize: 13 }}>
              © 2025 SaúdeMemora. Todos os direitos reservados.
            </p>
