  ...
  return (
    <div className="hm-page">
      ...
      <div className="hm-desc">
        <h2>O que é o SaúdeMemora?</h2>
        <p>
          O <strong>SaúdeMemora</strong> é sua plataforma digital para gerenciamento
          completo de documentos médicos. Com OCR e IA, transformamos documentos
          físicos em registros digitais organizados e acessíveis.
        </p>
      </div>
